...
async function connectionFromMongoAggregate({ aggregate, context, args = {}, loader, raw = false, allowDiskUse = false, }) {
    ...
    const { first, last, before, after, skip, limit, beforeOffset, afterOffset, startOffset, endOffset, startCursorOffset, endCursorOffset, } = (0, ConnectionFromMongoCursor_1.calculateOffsets)({ args, totalCount });
    ...
    const edges = slice.map((value, index) => ({
        cursor: (0, ConnectionFromMongoCursor_1.offsetToCursor)(startOffset + index),
    ...
    return {
        ...
        endCursorOffset,
        startCursorOffset,
        pageInfo: (0, ConnectionFromMongoCursor_1.getPageInfo)({
            edges,
            before,
            after,
            first,
